...
window.SFS.CONTENT = {
  ...
  stops: [
    /* ----------------------------- STOP 1 ----------------------------- */
    {
      ...
      coords: { lat: 51.53565529718996, lng: -0.06228797379001371 },
    ...
    /* ----------------------------- STOP 2 ----------------------------- */
    {
      ...
      coords: { lat: 51.54176823538392, lng: -0.14554839305060277 },
      ...
      locationPuzzle: {
        type: "code",
        prompt: "Control sent a picture code, Agent. Picture one is a spy's gadget for snapping sneaky photos — say its short, spy-style nickname. Picture two is a sly creature — name the place it goes home to sleep. Push the two words together, no space, to spell out the next market.",
        clue: "📷   +   🦊",
        answer: "CAMDEN",
        hints: [
          "What do spies call a camera for short? And what's the word for a fox's home?",
          "Now push those two short words together, with no space in between.",
    ...
    /* ----------------------------- STOP 3 (FINALE) ----------------------------- */
    {
      ...
      coords: { lat: 51.511203002392875, lng: -0.1318489743739439 },
